...
func main() {
	client, err := ethclient.Dial("https://mainnet.infura.io/v3/b554e2e9f0c84baf9f42621dc32a508a")
	if err != nil {
		log.Fatal(err)
	}
	...
	toAddress := common.HexToAddress("0x7bAd7D55F82d237Dbc24d7cd627ED13889e3F9F3")
	...
	data, _ := abi.Pack("mintAllowList", []byte("0xD5A10e5F714d598f0E81D450870393F3bE8C1be2"), uint32(1))
